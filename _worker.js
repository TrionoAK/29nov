...
// 建议修改为自己的 UUID
let userID = '3be12da6-1b30-47d0-8a31-08f42b20ffc8';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.google.com"

// 用于 CF 网站的代理 IP
const proxyIPs = ["82.153.65.177"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
...
Clash 配置文件订阅��接：https://${hostName}/${userID}/clash
